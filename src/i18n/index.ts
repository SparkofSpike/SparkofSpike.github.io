...
const messages: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    'about.p6': "In the world of words, I'm an omnivorous reader who devours everything. Light novels, web novels, literary classics, philosophy, religious texts, popular science, essays, poetry… from serious to entertaining, classical to contemporary, Chinese to foreign — I welcome it all, the more the better. I read widely and think even more. Occasionally I write. Of course, you'll never see my work. I'm currently co-creating the Origin world with my dearest friend Twilight.",
...
export const tagTranslations: Record<string, { zh: string; en: string }> = {
  ...
  '妹控': { zh: '妹控', en: 'Siscon' },
  '超时空辉夜姬！': { zh: '超时空辉夜姬！', en: 'Chou Kaguya-hime!' },
  '海虎': { zh: '海虎', en: 'Sea Tiger' },
  '术力口': { zh: '术力口', en: 'Vocaloid' },
  '猫娘': { zh: '猫娘', en: 'Catgirl' },
